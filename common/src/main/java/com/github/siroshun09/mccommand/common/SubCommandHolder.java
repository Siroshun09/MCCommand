...
public class SubCommandHolder {
     ...
     * @return the matched command, or {@code null} if there is no match.
     */
    @Nullable
    public Command search(@NotNull Argument argument) {
        Objects.requireNonNull(argument);
        return search(argument.get());
    }
     ...
     */
    @Nullable
    public Command search(@NotNull String str) {
        return searchOptional(str).orElse(null);
    }
